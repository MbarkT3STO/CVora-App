...
let cvData: CVBuiltData = emptyData();
let editingCV: CV | null = null;
let previewDebounce: ReturnType<typeof setTimeout> | null = null;

function emptyData(): CVBuiltData {
  return { name:'', title:'', email:'', phone:'', location:'', website:'', summary:'', experience:[], education:[], skills:[], languages:[] };
}
...
export function openCVBuilder(cv: CV | null, onSuccess: () => void): void {
  ...
  cvData = cv?.cvData ? structuredClone(cv.cvData) : emptyData();
